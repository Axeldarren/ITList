...
const AutocompleteSearch = ({ onSearch }: { onSearch: (query: string) => void }) => {
    ...
    return (
        <div className='relative flex h-min w-full md:w-[280px]'>
    ...
    <div className='flex items-center justify-between bg-white/80 dark:bg-black/60 backdrop-blur-sm border-b border-gray-100 dark:border-dark-tertiary px-2 md:px-4 py-2.5 relative z-30'>
        ...
        <div className='flex items-center gap-1 md:gap-1.5'>
            ...
            <button
              ...
              className="p-1.5 md:p-2 rounded-full text-gray-700 hover:bg-gray-100 transition-colors dark:text-gray-200 dark:hover:bg-white/5"
            >
            ...
            <div className='relative' ref={profileMenuRef}>
                ...
                >
                    ...
                    {userData && userData.profilePictureUrl && !imageError ? (
                        ...
                        <div className="h-7 w-7 md:h-8 md:w-8 rounded-full bg-gradient-to-br from-slate-300 to-slate-400 dark:from-slate-600 dark:to-slate-700 text-white flex items-center justify-center text-xs md:text-sm font-semibold">
                ...
                {isProfileMenuOpen && userData && (
                    <div className="absolute right-0 mt-2 w-56 md:w-64 rounded-xl shadow-xl ring-1 ring-black/5 dark:ring-white/10 bg-white dark:bg-dark-secondary z-50 overflow-hidden">
                        <div className="p-3">
